...
export const badgeClass = (variant: BadgeVariant) => `${badgeBase} ${badgeVariants[variant]}`;

export const miniBtnClass = 'bg-[#1a2230] border border-[#2c3a52] text-[#c9d3e0] rounded-lg px-2.5 py-1 text-xs cursor-pointer hover:bg-[#223052]';

export const searchInputClass = 'bg-[#0b0f16] border border-[#2b3850] rounded-lg text-[#e6e9ee] px-2.5 py-2 text-[13px] w-full outline-none focus:border-blue-600 placeholder:text-[#5b6b84]';

export const panelBoxClass = 'bg-[#0b0f16] border border-[#2b3850] rounded-lg px-3 py-2.5 text-[13px]';

export const astMetaClass = 'text-[#8b96a8] text-xs';

export const astCountClass = 'text-[#8b96a8] text-[11px] border border-[#2c3a52] rounded-full px-[7px]';

export const astPillBase = 'font-mono text-xs font-bold px-2 py-0.5 rounded-full border';
...
export const astPillClass = (kind: string) => `${astPillBase} ${astPillKinds[kind] ?? astPillKinds.leaf}`;

export const tokenTypeColors: Record<string, string> = {
